...
env="DEV"
echo -n "Type PROD for prod deploy, will push to DEV otherwise"
echo
read -r env
...
then
    ...
    KEY="67f3d1f0f02c2d8fc410e600:e29e2636e93814780098c45b5a6f37753056dd8041fb460f16a5280e339e9a94"
fi


echo "-------------------------------------------------------------------------------------------------------------------"
echo "Cleaning workspace and building project"
echo "-------------------------------------------------------------------------------------------------------------------"
rm ./dist/*.zip
